...
val greeting: String = "Hello, Kotlin!"
    ...
    fun findMax(numbers: List<Int>): Int {
        ...
        return numbers.maxOrNull() ?: throw IllegalArgumentException("List cannot be empty")
    }
    ...
    fun charFrequency(str: String): Map<Char, Int> {
        // Filter the string to only include letters and convert to lowercase for case insensitivity
